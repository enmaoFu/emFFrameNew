package com.em.baseframe.view.popupwindow;
...
import com.em.baseframe.view.popupwindow.pedant.SweetAlert.ProgressHelper;
import com.em.baseframe.view.popupwindow.pnikosis.materialishprogress.ProgressWheel;
import com.em.baseframe.view.popupwindow.titanic.Titanic;
import com.em.baseframe.view.popupwindow.titanic.TitanicTextView;
                ...
                public void onTick(long millisUntilFinished) {
                    if (DIALOG_STYLE_CURRENT == DIALOG_STYLE_PROGRESS) {
                        ...
                        if(progressColorResID!=null){
                            switch (count % 7) {
                                case 0:
                                    mProgressHelper.setBarColor(progressColorResID.length>=1?progressColorResID[0]:context.getResources().getColor(R.color.blue_btn_bg_color));
                                    break;
                                case 1:
                                    mProgressHelper.setBarColor(progressColorResID.length>=2?progressColorResID[1]:context.getResources().getColor(R.color.material_deep_teal_50));
                                    break;
                                case 2:
                                    mProgressHelper.setBarColor(progressColorResID.length>=3?progressColorResID[2]:context.getResources().getColor(R.color.success_stroke_color));
                                    break;
                                case 3:
                                    mProgressHelper.setBarColor(progressColorResID.length>=4?progressColorResID[3]:context.getResources().getColor(R.color.material_deep_teal_20));
                                    break;
                                case 4:
                                    mProgressHelper.setBarColor(progressColorResID.length>=5?progressColorResID[4]:context.getResources().getColor(R.color.material_blue_grey_80));
                                    break;
                                case 5:
                                    mProgressHelper.setBarColor(progressColorResID.length>=6?progressColorResID[5]:context.getResources().getColor(R.color.warning_stroke_color));
                                    break;
                                case 6:
                                    mProgressHelper.setBarColor(progressColorResID.length>=7?progressColorResID[6]:context.getResources().getColor(R.color.success_stroke_color));
                                    break;
                            }
                        }else{
                            switch (count % 7) {
                                case 0:
                                    ...
                                    break;
                                case 1:
                                    mProgressHelper.setBarColor(context.getResources().getColor(R.color.material_deep_teal_50));
                                    break;
                                case 2:
                                    mProgressHelper.setBarColor(context.getResources().getColor(R.color.success_stroke_color));
                                    break;
                                case 3:
                                    mProgressHelper.setBarColor(context.getResources().getColor(R.color.material_deep_teal_20));
                                    break;
                                case 4:
                                    mProgressHelper.setBarColor(context.getResources().getColor(R.color.material_blue_grey_80));
                                    break;
                                case 5:
                                    mProgressHelper.setBarColor(context.getResources().getColor(R.color.warning_stroke_color));
                                    break;
                                case 6:
                                    mProgressHelper.setBarColor(context.getResources().getColor(R.color.success_stroke_color));
                                    break;
